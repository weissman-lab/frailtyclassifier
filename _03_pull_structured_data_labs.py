...
import os
import pandas as pd
from _99_project_module import get_clarity_conn, get_from_clarity_then_save, combine_notes_by_type,     query_filtered_with_temp_tables, write_txt, read_txt, nrow
import re
import time
...
labs
'''
if "labs_raw_w4.pkl" not in os.listdir(datadir):
    ...
    labdf = pd.read_pickle(f"{datadir}labs_raw_w4.pkl")
