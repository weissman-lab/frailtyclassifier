...
FROM PAT_ENC as e
  left join PAT_ENC_2 as e2 on e2.PAT_ENC_CSN_ID = e.PAT_ENC_CSN_ID
       ...
       inner join HNO_INFO as hi on  hi.PAT_ENC_CSN_ID = e.PAT_ENC_CSN_ID
       inner join ZC_NOTE_TYPE_IP on hi.IP_NOTE_TYPE_C = ZC_NOTE_TYPE_IP.TYPE_IP_C 
       inner join NOTE_ENC_INFO as nei on nei.NOTE_ID = hi.NOTE_ID
       inner join HNO_NOTE_TEXT as hnt on nei.CONTACT_SERIAL_NUM = hnt.NOTE_CSN_ID and hnt.NOTE_TEXT <> ''
