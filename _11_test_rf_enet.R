...
if (file.exists('/gwshare/frailty/output/figures_tables/nn_multi_test_set_performance.csv')) {
  nn_multi_test_perf <- fread('/gwshare/frailty/output/figures_tables/nn_multi_test_set_performance.csv')
} else{
  bbs <- list()
  for (b in 1:length(batches)){
    tbs <- list()
...
if (file.exists('/gwshare/frailty/output/figures_tables/nn_single_test_set_performance.csv')) {
  nn_single_test_perf <- fread('/gwshare/frailty/output/figures_tables/nn_single_test_set_performance.csv')
} else{
  bbs <- list()
  for (b in 1:length(batches)){
    tbs <- list()
